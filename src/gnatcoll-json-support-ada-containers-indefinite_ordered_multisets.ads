...
generic
   with package S is new Standard.Ada.Containers.Indefinite_Ordered_Multisets (<>);
   use S;

   with function Create (Val : Element_Type) return JSON_Value is <>;
   with function Get (Val : JSON_Value) return Element_Type is <>;

package GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Ordered_Multisets is
...
end GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Ordered_Multisets;
