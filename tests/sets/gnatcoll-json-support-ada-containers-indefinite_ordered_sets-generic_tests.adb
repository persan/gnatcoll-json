...
package body GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Ordered_Sets.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Ordered_Sets.Generic_Tests;
