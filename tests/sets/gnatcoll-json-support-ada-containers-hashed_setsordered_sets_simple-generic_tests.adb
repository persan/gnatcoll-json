...
package body GNATCOLL.JSON.Support.Ada.Containers.Hashed_SetsOrdered_Sets_SImple.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Hashed_SetsOrdered_Sets_SImple.Generic_Tests;
