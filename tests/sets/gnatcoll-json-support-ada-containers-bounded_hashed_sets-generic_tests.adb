...
package body GNATCOLL.JSON.Support.Ada.Containers.Bounded_Hashed_Sets.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Bounded_Hashed_Sets.Generic_Tests;
