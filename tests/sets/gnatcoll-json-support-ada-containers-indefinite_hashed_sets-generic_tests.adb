...
package body GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Hashed_Sets.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Hashed_Sets.Generic_Tests;
