...
package body GNATCOLL.JSON.Support.Ada.Containers.Indefinite_Doubly_Linked_Lists.Generic_Test is
   ...
   begin
      Test.Test_Data := new List'(Initialize);
   end Set_Up_Case;
   ...
   procedure Test_Read (Test : in out AUnit.Test_Cases.Test_Case'Class)  is
      Td   : Test_Case renames Test_Case (Test);
   begin
      Td.Result := new List'(Get (GNATCOLL.JSON. Read (Read (Ada2file (Unit_Name)),
