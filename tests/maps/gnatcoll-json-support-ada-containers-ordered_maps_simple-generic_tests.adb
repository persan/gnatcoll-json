...
package body GNATCOLL.JSON.Support.Ada.Containers.Ordered_Maps_SImple.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Ordered_Maps_Simple.Generic_Tests;
