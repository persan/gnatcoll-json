...
package body GNATCOLL.JSON.Support.Ada.Containers.Bounded_Hashed_Maps.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Bounded_Hashed_Maps.Generic_Tests;
