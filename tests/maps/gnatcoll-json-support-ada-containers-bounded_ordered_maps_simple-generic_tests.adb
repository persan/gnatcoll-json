...
package body GNATCOLL.JSON.Support.Ada.Containers.Bounded_Ordered_Maps_SImple.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Bounded_Ordered_Maps_SImple.Generic_Tests;
