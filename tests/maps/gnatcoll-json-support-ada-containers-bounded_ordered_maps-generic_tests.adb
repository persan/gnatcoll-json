...
package body GNATCOLL.JSON.Support.Ada.Containers.Bounded_Ordered_Maps.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Bounded_Ordered_Maps.Generic_Tests;
