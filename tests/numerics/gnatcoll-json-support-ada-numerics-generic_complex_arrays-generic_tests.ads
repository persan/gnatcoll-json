...
generic
package GNATCOLL.JSON.Support.Ada.Numerics.Generic_Complex_Arrays.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Numerics.Generic_Complex_Arrays.Generic_Tests;
