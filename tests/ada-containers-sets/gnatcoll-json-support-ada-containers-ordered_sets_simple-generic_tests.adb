...
package body GNATCOLL.JSON.Support.Ada.Containers.Ordered_Sets_SImple.Generic_Tests is
...
end GNATCOLL.JSON.Support.Ada.Containers.Ordered_Sets_SImple.Generic_Tests;
