...
with GNATCOLL.JSON.Support.Test.Integer_Bounded_Ordered_Maps.Simple_JSON.Tests;
with GNATCOLL.JSON.Support.Test.Integer_Indefinite_Hashed_Maps.JSON.Tests;
with GNATCOLL.JSON.Support.Test.Integer_Indefinite_Hashed_Maps.Simple_JSON.Tests;
with GNATCOLL.JSON.Support.Test.Integer_Indefinite_Ordered_Maps.JSON.Tests;
with GNATCOLL.JSON.Support.Test.Integer_Indefinite_Ordered_Maps.Simple_JSON.Tests;
with GNATCOLL.JSON.Support.Test.Integer_Hashed_Maps.JSON.Tests;
...
package body GNATCOLL.JSON.Support.Test.Map_Suites is
   ...
   begin
      Add_Test (Result'Access, Test_Bounded_Hashed_Maps'Access);
      Add_Test (Result'Access, Test_Bounded_Hashed_Maps_Simple'Access);
      Add_Test (Result'Access, Test_Bounded_Ordered_Maps'Access);
      Add_Test (Result'Access, Test_Bounded_Ordered_Maps_Simple'Access);
      Add_Test (Result'Access, Test_Indefinite_Hashed_Maps'Access);
      Add_Test (Result'Access, Test_Indefinite_Hashed_Maps_Simple'Access);
      Add_Test (Result'Access, Test_Indefinite_Ordered_Maps'Access);
      Add_Test (Result'Access, Test_Indefinite_Ordered_Maps_Simple'Access);
      Add_Test (Result'Access, Test_Hashed_Maps'Access);
