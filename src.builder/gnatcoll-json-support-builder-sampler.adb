...
package body GNATCOLL.JSON.Support.Builder.Sampler is
   ...
   --  Checks, that GNATCOLL.JSON.Support.Builder options and files existing in the file
   ...
   --  GNATCOLL.JSON.Support.Builder.Options.Header is set to From_Spec, for sununit it does NOT
   ...
   begin
      ...
      Info ("  --help                 DisplaGNATCOLL.JSON.Support.Buildery usage and exit");
      Info ("");
   ...
   begin
      ...
      if GNATCOLL.JSON.Support.Builder.Projects.Is_Specified (GNATCOLL.JSON.Support.Builder.Options.Builder_Prj) then

         Arg_Virt_File :=
           GNATCOLL.JSON.Support.Builder.Projects.Create
             (GNATCOLL.JSON.Support.Builder.Options.Builder_Prj, +File_Name.all);
         ...
         Arg_File_Info := Info (GNATCOLL.JSON.Support.Builder.Options.Builder_Prj, Arg_Virt_File);
      ...
      then
         ...
         raise Parameter_Error;
         --    elsif GNATCOLL.JSON.Support.Builder.Projects.Is_Specified (GNATCOLL.JSON.Support.Builder.Options.Support.Builder_Prj) then
      ...
      if GNATCOLL.JSON.Support.Builder.Options.Builder_Prj.Is_Specified then
         GNATCOLL.JSON.Support.Builder.Projects.Set_Global_Result_Dirs
           (GNATCOLL.JSON.Support.Builder.Options.Builder_Prj);
         GNATCOLL.JSON.Support.Builder.Projects.Set_Individual_Source_Options
           (GNATCOLL.JSON.Support.Builder.Options.Builder_Prj);
         Set_Arg_List;
      end if;
   ...
   begin
      ...
      if Is_Nil (CU) then
         Error ("file " & GNATCOLL.JSON.Support.Builder.Options.File_Name.all &
